 ...
 * @return 0 if succeed. Otherwise, returns the appropriate AVERROR.
 */
static int ff_parse_full_itu_t_t35_to_dynamic_hdr10_plus(AVDynamicHDRPlus* s, const uint8_t* data,
					     int size);
 ...
 * @return 0 if succeed. Otherwise, returns the appropriate AVERROR.
 */
static int ff_write_dynamic_hdr10_plus_to_full_itu_t_t35(const AVDynamicHDRPlus* s, uint8_t** data, size_t* size);
